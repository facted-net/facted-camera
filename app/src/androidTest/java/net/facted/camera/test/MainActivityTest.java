package net.facted.camera.test;
...
import net.facted.camera.MainActivity;
import net.facted.camera.PreferenceKeys;
import net.facted.camera.SaveLocationHistory;
import net.facted.camera.CameraController.CameraController;
import net.facted.camera.Preview.Preview;
import net.facted.camera.UI.FolderChooserDialog;
import net.facted.camera.UI.PopupView;
...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public MainActivityTest() {
		super("net.facted.camera", MainActivity.class);
	}
	...
	private void switchToFlashValue(String required_flash_value) {
		if( mPreview.supportsFlash() ) {
			...
			if( !flash_value.equals(required_flash_value) ) {
			    ...
			    View popupButton = mActivity.findViewById(net.facted.camera.R.id.popup);
	...
	private void setToDefault() {
		if( mPreview.isVideo() ) {
		    ...
		    View switchVideoButton = mActivity.findViewById(net.facted.camera.R.id.switch_video);
		...
		if( mPreview.getCameraControllerManager().getNumberOfCameras() > 1 ) {
			...
			while( cameraId != 0 ) {
			    View switchCameraButton = mActivity.findViewById(net.facted.camera.R.id.switch_camera);
	...
	public void testSaveVideoMode() {
		...
		View takePhotoButton = mActivity.findViewById(net.facted.camera.R.id.take_photo);
	    View switchVideoButton = mActivity.findViewById(net.facted.camera.R.id.switch_video);

	    assertTrue(!mPreview.isVideo());
		assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.take_photo) ) );
		assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.switch_to_video) ) );

	    clickView(switchVideoButton);
	    assertTrue(mPreview.isVideo());
		assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.start_video) ) );
		assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.switch_to_photo) ) );
	...
	public void testFlashStartup() throws InterruptedException {
	    ...
	    //View flashButton = mActivity.findViewById(net.facted.camera.R.id.flash);
	    //clickView(flashButton);
		switchToFlashValue("flash_torch");
	...
	public void testAutoFocus() throws InterruptedException {
		...
		for(String supported_focus_value : supported_focus_values) {
		    ...
		    //View focusModeButton = mActivity.findViewById(net.facted.camera.R.id.focus_mode);
	...
	private void subTestFocusFlashAvailability() {
	    //View focusModeButton = mActivity.findViewById(net.facted.camera.R.id.focus_mode);
	    //View flashButton = mActivity.findViewById(net.facted.camera.R.id.flash);
	    View exposureButton = mActivity.findViewById(net.facted.camera.R.id.exposure);
	    View exposureLockButton = mActivity.findViewById(net.facted.camera.R.id.exposure_lock);
	    View popupButton = mActivity.findViewById(net.facted.camera.R.id.popup);
	...
	public void testTakePhotoExposureCompensation() throws InterruptedException {
	    ...
	    View exposureButton = mActivity.findViewById(net.facted.camera.R.id.exposure);
		View exposureContainer = mActivity.findViewById(net.facted.camera.R.id.exposure_container);
		SeekBar seekBar = (SeekBar) mActivity.findViewById(net.facted.camera.R.id.exposure_seekbar);
	    ZoomControls seekBarZoom = (ZoomControls) mActivity.findViewById(net.facted.camera.R.id.exposure_seekbar_zoom);
	...
	public void testTakePhotoManualISOExposure() throws InterruptedException {
		...
		View exposureButton = mActivity.findViewById(net.facted.camera.R.id.exposure);
		View exposureContainer = mActivity.findViewById(net.facted.camera.R.id.manual_exposure_container);
		SeekBar isoSeekBar = (SeekBar) mActivity.findViewById(net.facted.camera.R.id.iso_seekbar);
	    SeekBar exposureTimeSeekBar = (SeekBar) mActivity.findViewById(net.facted.camera.R.id.exposure_time_seekbar);
	    assertTrue(exposureButton.getVisibility() == View.VISIBLE);
	    assertTrue(exposureContainer.getVisibility() == View.GONE);
	...
	public void testAudioControlIcon() {
	    ...
	    View audioControlButton = mActivity.findViewById(net.facted.camera.R.id.audio_control);
	    ...
	    audioControlButton = mActivity.findViewById(net.facted.camera.R.id.audio_control);
	...
	private void subTestTakePhoto(boolean locked_focus, boolean immersive_mode, boolean touch_to_focus, boolean wait_after_focus, boolean single_tap_photo, boolean double_tap_photo, boolean is_raw, boolean test_wait_capture_result) throws InterruptedException {
	    ...
	    View switchVideoButton = mActivity.findViewById(net.facted.camera.R.id.switch_video);
	    //View flashButton = mActivity.findViewById(net.facted.camera.R.id.flash);
	    //View focusButton = mActivity.findViewById(net.facted.camera.R.id.focus_mode);
	    View exposureButton = mActivity.findViewById(net.facted.camera.R.id.exposure);
	    View exposureLockButton = mActivity.findViewById(net.facted.camera.R.id.exposure_lock);
	    View audioControlButton = mActivity.findViewById(net.facted.camera.R.id.audio_control);
	    View popupButton = mActivity.findViewById(net.facted.camera.R.id.popup);
	    View trashButton = mActivity.findViewById(net.facted.camera.R.id.trash);
	    View shareButton = mActivity.findViewById(net.facted.camera.R.id.share);
	...
	public void testTakePhotoFrontCamera() throws InterruptedException {
		...
		assertTrue(cameraId != new_cameraId);
		assertTrue( contentDescription.equals( mActivity.getResources().getString(new_is_front_facing ? net.facted.camera.R.string.switch_to_front_camera : net.facted.camera.R.string.switch_to_back_camera) ) );
		assertTrue( new_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? net.facted.camera.R.string.switch_to_front_camera : net.facted.camera.R.string.switch_to_back_camera) ) );
		subTestTakePhoto(false, false, true, true, false, false, false, false);
		...
		assertTrue( restart_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? net.facted.camera.R.string.switch_to_front_camera : net.facted.camera.R.string.switch_to_back_camera) ) );
	...
	public void testTakePhotoManualFocus() throws InterruptedException {
		...
		setToDefault();
	    SeekBar seekBar = (SeekBar) mActivity.findViewById(net.facted.camera.R.id.focus_seekbar);
	...
	public void testImmersiveMode() throws InterruptedException {
	    ...
	    View trashButton = mActivity.findViewById(net.facted.camera.R.id.trash);
	    View shareButton = mActivity.findViewById(net.facted.camera.R.id.share);
	    View zoomSeekBar = mActivity.findViewById(net.facted.camera.R.id.zoom_seekbar);
		View takePhotoButton = mActivity.findViewById(net.facted.camera.R.id.take_photo);
		View pauseVideoButton = mActivity.findViewById(net.facted.camera.R.id.pause_video);
	    assertTrue(switchCameraButton.getVisibility() == View.VISIBLE);
	    assertTrue(switchVideoButton.getVisibility() == View.VISIBLE);
	    int exposureVisibility = exposureButton.getVisibility();
	    int exposureLockVisibility = exposureLockButton.getVisibility();
	...
	private void subTestTakeVideo(boolean test_exposure_lock, boolean test_focus_area, boolean allow_failure, boolean immersive_mode, VideoTestCallback test_cb, long time_ms, boolean max_filesize, boolean subtitles) throws InterruptedException {
	    ...
	    View switchVideoButton = mActivity.findViewById(net.facted.camera.R.id.switch_video);
		if( mPreview.isVideo() ) {
			assertTrue( (Integer)takePhotoButton.getTag() == net.facted.camera.R.drawable.take_video_selector );
			assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.start_video) ) );
			assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.pause_video) ) );
			assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.switch_to_photo) ) );
		}
		else {
			assertTrue( (Integer)takePhotoButton.getTag() == net.facted.camera.R.drawable.take_photo_selector );
			assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.take_photo) ) );
			assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.pause_video) ) );
			assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.switch_to_video) ) );
		}
	    ...
	    if( mPreview.isTakingPhoto() ) {
		    assertTrue( (Integer)takePhotoButton.getTag() == net.facted.camera.R.drawable.take_video_recording );
			assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.stop_video) ) );
			assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.pause_video) ) );
	    ...
	    assertTrue( (Integer)takePhotoButton.getTag() == net.facted.camera.R.drawable.take_video_selector );
		assertEquals( takePhotoButton.getContentDescription(), mActivity.getResources().getString(net.facted.camera.R.string.start_video) );
		assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.pause_video) ) );
	...
	public void testTakeVideoPause() throws InterruptedException {
		...
		subTestTakeVideo(false, false, false, false, new VideoTestCallback() {
			...
			public int doTest() {
				...
				assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.facted.camera.R.string.resume_video) ) );
				assertTrue( pauseVideoButton.getVisibility() == View.VISIBLE );
				assertTrue( mPreview.isVideoRecording() );
				assertTrue( mPreview.isVideoRecordingPaused() );
	...
	public void testTakeVideoSettings() throws InterruptedException {
		...
		// now go to settings
	    View settingsButton = mActivity.findViewById(net.facted.camera.R.id.settings);
	...
	private void subTestTimer(int type) {
		...
		try {
			...
			takePhotoButton = mActivity.findViewById(net.facted.camera.R.id.take_photo);
	...
	public void testZoom() {
	    ...
	    final ZoomControls zoomControls = (ZoomControls) mActivity.findViewById(net.facted.camera.R.id.zoom);
	    ...
	    final SeekBar zoomSeekBar = (SeekBar) mActivity.findViewById(net.facted.camera.R.id.zoom_seekbar);
		assertTrue(zoomSeekBar.getVisibility() == View.VISIBLE);
	...
	public void testGallery() {
	    ...
	    View galleryButton = mActivity.findViewById(net.facted.camera.R.id.gallery);
